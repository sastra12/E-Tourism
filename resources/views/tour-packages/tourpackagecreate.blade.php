...
<div class="container mt-5">
  <div class="row justify-content-center">
      <div class="col-md-6">
          <div class="card">
              <h5 class="card-header">Tambah Data Pemesan</h5>
              <div class="card-body">
                  <form action="{{ route('tourpackages.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('destinasi') is-invalid @enderror" id="destinasi" name="destinasi" value="{{ old('destinasi') }}">
                        @error('destinasi')
                          <div class="alert alert-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
